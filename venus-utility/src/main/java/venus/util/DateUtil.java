...
public class DateUtil {
    ...
    public static String dateMinusDay(int num) {

        SimpleDateFormat sdf = new SimpleDateFormat(DAY_PATTERN);
        Calendar currentDay = Calendar.getInstance();
        currentDay.add(Calendar.DAY_OF_YEAR, num);// 日期减1个月
        Date dt1 = currentDay.getTime();
        String reStr = sdf.format(dt1).concat(" 00:00:00");
        return reStr;
    }
}
