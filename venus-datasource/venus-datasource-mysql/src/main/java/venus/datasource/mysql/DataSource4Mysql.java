...
/**
 * <p> DataSource for mysql implements </p>
 *
 * @author changming.Y <changming.yang.ah@gmail.com>
 * @since 2018-05-02 11:09
 */
@SpiMeta(name = "mysql")
public class DataSource4Mysql implements DataSource {

    private static final Logger logger = Logger.getLogger(DataSource4Mysql.class);

    public Connection getConnection() {
        List<Config> configs = ConfigFactory.fetchConfigByKeywords("datasource_mysql");
        if (configs!=null && configs.size()>0){
            ...
            try {
                ...
                logger.error("Failure for get Connection!");
