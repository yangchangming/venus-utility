 ...
 */
package venus.datasource.oracle.config;
 ...
 * @since 2018-06-08 08:56
 */
@SpiMeta(name = "oracle")
public class ConfigRegister4Oracle implements ConfigRegister {

    private final String DATASOURCE_CONFIG_NAME = "datasource_oracle.properties";
    private static Logger logger = Logger.getLogger(ConfigRegister4Oracle.class);
