 ...
 * 
 * <p>
 * For full information see the Safari and WebKit Version Information: <a
 * href="http://developer.apple.com/internet/safari/uamatrix.html">at Apple
 * Developer Connection</a> and for browsers in general, see this fairly
 * complete <a
 * href="http://www.useragentstring.com/pages/useragentstring.php">list of user
 * agent strings</a>.
 * </p>
 * 
...
public class BrowserDetect {
    private static Log logger = LogFactory.getLog(BrowserDetect.class);

    /**
     * How many connections can this browser open simultaneously?
     * 
     * @param request
     *            The request so we can get at the user-agent header
     ...
     * 
     * @param request
     *            The browsers request
     * @param requiredUserAgent
     *            The UA required
     * @return true iff the browser matches the spec.
     */
    public static boolean atLeast(HttpServletRequest request,
     ...
     *            The browsers request
     * @param requiredUserAgent
     *            The UA required. Currently this is major version only
     * @param requiredVersion
     *            The version required, or -1 if versions are not important
     * @return true iff the browser matches the spec.
     */
    public static boolean atLeast(HttpServletRequest request,
                                  UserAgent requiredUserAgent, int requiredVersion) {
        String userAgent = request.getHeader("user-agent");
        int realVersion;
        ...
        default:
            throw new UnsupportedOperationException("Detection of "
                    + requiredUserAgent + " is not supported yet.");
        }
