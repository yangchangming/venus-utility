...
public class StringHelperTools {
    ...
    public static String prt(String myString) {
        if (myString != null && !"null".equals(myString))
            return myString;
        else
            return "";
    }
    ...
    public static String prtBoolean(Object obj) {
        if (obj == null) {
            return venus.frames.i18n.util.LocaleHolder.getMessage("venus.authority.No0");
        }
        if (obj instanceof Boolean) {
            return ((Boolean)obj)?venus.frames.i18n.util.LocaleHolder.getMessage("venus.authority.Be"):venus.frames.i18n.util.LocaleHolder.getMessage("venus.authority.No0");
        }
        ...
        if (stringValue.equalsIgnoreCase("yes") ||
            ...
            return venus.frames.i18n.util.LocaleHolder.getMessage("venus.authority.Be");
    ...
    public static String getPercentage(double numerator, double denominator) {
        ...
        if(String.valueOf(percentage).endsWith(String.valueOf(Double.NaN))) {
            return venus.frames.i18n.util.LocaleHolder.getMessage("venus.authority.Air");
        }
	...
	public static String updateIdCard(String oldIdCard) {
		...
		try {
		    ...
		    throw new RuntimeException(venus.frames.i18n.util.LocaleHolder.getMessage("venus.authority.Please_enter_a_valid_identity_card_number_format")+"!");
		}
		int y = iSum % 11;
