/*
 * 系统名称: HBCC-EIP2-EIP --> eip
 * 
 * 文件名称: com.use.au.tools.test.tree.bs.impl --> RmXmlHelper.java
 * 
 * 功能描述:
 * 
...
public class DeepTreeXmlHandler {
    ...
    public String getStringFromDocument() {
        ...
        String returnValue = "";
		try {
			returnValue = bytesStream.toString("UTF-8");
		} catch (Exception e1) {
			e1.printStackTrace();
		}
        return returnValue;
    ...
    public static void main(String[] args) {
        ...
        dt.addTreeNode(new DeepTreeVo("1", venus.frames.i18n.util.LocaleHolder.getMessage("venus.authority.Sales"), "1", "xmlData.xml"));
        dt.addTreeNode(new DeepTreeVo("2", venus.frames.i18n.util.LocaleHolder.getMessage("venus.authority.Development_Center"), "1", "xmlData.xml"));
