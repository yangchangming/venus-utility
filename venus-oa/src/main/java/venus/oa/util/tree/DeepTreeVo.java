...
public class DeepTreeVo {
     ...
     */
    private Map mapAttribute;
    
    /**
     * lKeyIndex 表示: 体现key值先后顺序的List
     */
    private List lKeyIndex;
    ...
    public void setIsDisable(String isDisable) {
        addAttribute("isDisable", isDisable);
    }
