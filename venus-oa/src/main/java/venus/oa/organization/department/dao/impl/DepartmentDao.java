 ...
 * 系统名称:单表模板 --> test
 * 
 * 文件名称: venus.authority.sample.department.dao.impl --> DepartmentDao.java
 * 
 * 功能描述:
 * 
 * 版本历史: 2007-01-31 14:20:09.963 创建1.0.0版 (甘硕)
 *  
 */
...
public class DepartmentDao extends BaseTemplateDao implements IDepartmentDao, IDepartmentConstants {
     ...
     */
    public OID insert(DepartmentVo vo) {
        
        VoHelperTools.null2Nothing(vo); //把vo中null值替换为""
        Object[] obj = { vo.getId(), vo.getDept_no(),vo.getDept_name(),vo.getDept_flag(),vo.getDept_type(),vo.getDept_level(),vo.getDept_leader(),vo.getRemark(),vo.getEnable_status(),vo.getEnable_date(),vo.getCreate_date(),vo.getModify_date(),vo.getColumn1(),vo.getColumn2(),vo.getColumn3() };
    ...
    public DepartmentVo find(String id) {
        return (DepartmentVo) queryForObject("select * from AU_DEPARTMENT where ID=?", new Object[] { id }, new RowMapper() {
    ...
    public int update(DepartmentVo vo) {
        VoHelperTools.null2Nothing(vo); //把vo中null值替换为""
        Object[] obj = { vo.getDept_no(),vo.getDept_name(),vo.getDept_flag(),vo.getDept_type(),vo.getDept_level(),vo.getDept_leader(),vo.getRemark(),vo.getEnable_status(),vo.getEnable_date(),vo.getCreate_date(),vo.getModify_date(),vo.getColumn1(),vo.getColumn2(),vo.getColumn3(), vo.getId() };
