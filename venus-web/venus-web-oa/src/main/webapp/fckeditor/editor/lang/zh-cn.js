...
GbosResource  : "Gbox资源",
DlgBtnBrowseGboxResource :"浏览GBox资源",
DlggbosDescription :"图片的预览，以及高度、宽度的设置请在‘图片’标签页进行调整",
DlgGboxLinkTag :"链接Gbox资源文件",
AlertMessageFileRenamed :"文件重名不可用。上传文件改名为",
AlertMessageInvalidFileType :"无效的类型",
AlertMessageNoPermissionsToUpload :"安全错误。你没有足够权限上传文件。请检查服务器设置。",
AlertMessageFileSizeLimitIsExceeded :"上传文件大小超出限制",
AlertMessageConnectorDisabled :"连接不可用",
AlertMessageErrorOnFileUploadNumber :"文件上传错误。错误代码： "
};
