angular.module('gap.ewp.posts.postManagementModel', ['ngGrid', 'gap.ewp.posts.util'])
    .controller('gap.posts.user.postManagementCtrl', function ($scope, $http, $log, $modal,webContextPathService) {

        $scope.cprsInit = {'conditions': {'CONTENT': '', 'usrName': '', 'WEB_SITE_ID': ''}, 'results': null,
        ...
        $scope.getPagedDataAsync = function () {
            ...
            $http({
                method: 'POST',
                url: webContextPathService.getWebContextPath()+'/apis/ewp/posts/getPostsByAdmin',
                data: data,
                headers: {
