...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>&nbsp;&nbsp;</td>
      ...
      <table width="100%" height="600"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
        <tr>
          <td bgcolor="#FFFFFF">
    ...
    <td valign="top">
      <table width="95%"  height="600"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#cccccc" >
        <tr>
