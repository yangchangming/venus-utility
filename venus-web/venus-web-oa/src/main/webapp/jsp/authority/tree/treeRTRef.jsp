...
if(org.apache.commons.lang.StringUtils.isNotEmpty(partyType)){
	venus.oa.organization.auconnectrule.vo.AuConnectRuleVo obj = new venus.oa.organization.auconnectrule.vo.AuConnectRuleVo();
	//obj.setParent_partytype_id(partyType);
	obj.setChild_partytype_id(partyType);
    java.util.List list = ((venus.oa.organization.auconnectrule.bs.IAuConnectRuleBS)BeanFactoryHelper.getBean("auConnectRuleBS")).queryByType(obj);
    for(int i=0;i<list.size();i++){
        venus.oa.organization.auconnectrule.vo.AuConnectRuleVo ruleVo = (venus.oa.organization.auconnectrule.vo.AuConnectRuleVo)list.get(i);
...
src+=("&rootXmlSource="+venus.oa.util.StringHelperTools.encodeUrl(request.getParameter("rootXmlSource"))+"%26parent_code%3D");
%>
<html>
<head>
