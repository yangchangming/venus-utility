...
<table class="table_noFrame">
	<tr>
		<td>&nbsp;&nbsp;
			...
			<input name="button_cancel" class="button_ellipse" type="button" value="<fmt:message key='venus.authority.Cancel' bundle='${applicationAuResources}' />"  onclick="cancel_onClick();" >
		</td>
	</tr>
</table>
<table class="table_noFrame">
