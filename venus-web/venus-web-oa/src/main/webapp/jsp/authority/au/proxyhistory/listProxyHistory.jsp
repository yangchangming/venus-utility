...
<%@page import="venus.authority.au.auproxy.util.IConstants"%>
...
<script language="javascript">
    ...
    function simpleQuery_onClick(){  //简单的模糊查询
        form.action="<%=request.getContextPath()%>/auProxyHistory/simpleQuery?forwardPage=listPage";
        form.submit();
    }
        ...
        <td>
            <table class="table_noFrame" width="100%">
                <tr>
                    ...
                    <td width="15%" align="right"><fmt:message key='venus.authority.Proxy0' bundle='${applicationAuResources}' /></td>
                    <td width="35%" align="left">
                        <input type="text" class="text_field" validate="isSearch" name="recipient" inputName="<fmt:message key='venus.authority.Proxy0' bundle='${applicationAuResources}' />" maxLength="50"/>
                    </td>
                </tr>
                <tr>
