...
<script language="javascript">
	var tabs  =  new Array(
		new Array ("<fmt:message key='venus.authority.Functional_competence' bundle='${applicationAuResources}' />","<venus:base/>/auAuthorizeLog/viewFuncAu?vCode=<%=vCode%>&auHisTag=<%=auHisTag%>"),
