...
<!--菜单树开始-->   
		<script language="javascript">
			...
			var selTxtArray = new Array("<fmt:message key='venus.authority.Read_only' bundle='${applicationAuResources}' />","<fmt:message key='venus.authority.Can_write' bundle='${applicationAuResources}' />","<fmt:message key='venus.authority.May_authorize' bundle='${applicationAuResources}' />");
		...
		<script language="javascript">
			if (document.getElementById){
				//根节点
				var t0=new WebFXTree('<b><fmt:message key='venus.authority.Field_Resources' bundle='${applicationAuResources}' /></b>','',selTxtArray,selValArray);
...
%>
				...
				"<%="<fmt:message key='venus.authority.Field_name' bundle='${applicationAuResources}' />:"+vo.getField_name()+";<fmt:message key='venus.authority.Chinese_name_field' bundle='${applicationAuResources}' />:"+vo.getField_chinesename()+";<fmt:message key='venus.authority.Notes' bundle='${applicationAuResources}' />:"+vo.getHelp()%>",
