...
<script>
	...
	function view_onClick(id){//查看详细页面
		...
		form.action = "<venus:base/>/auPartyRelationType/detailPage?id=" + id;
		form.submit();
	}
	...
	function findCheckbox_onClick() {  //从多选框到修改页面
		...
		form.action = "<venus:base/>/auPartyRelationType/find?ids=" + ids;
		form.submit();
	}
	function detail_onClick(thisId){
		<%--form.action = "<venus:base/>/AuPartyRelationTypeAction.do?cmd=find&ids=" + thisId;--%>
		form.action = "<venus:base/>/auPartyRelationType/find?ids=" + thisId;
		form.submit();
	}
	function deleteMulti_onClick(){  //从多选框物理删除多条记录
		...
		if(confirm("<fmt:message key='venus.authority.It_completely_remove_the_data_' bundle='${applicationAuResources}' />")) {
			...
			form.action="<venus:base/>/auPartyRelationType/delete?ids=" + ids;
    		form.submit();
		}
	}
	...
	function enable_onClick() {  //从多选框到修改页面
		...
		form.action="<venus:base/>/auPartyRelationType/enable?ids=" + ids;
		form.submit();
	}   
	function disable_onClick() {  //从多选框到修改页面
		...
		form.action="<venus:base/>/auPartyRelationType/disable?ids=" + ids;
		form.submit();
	}  
	function initFocus(){ 
...
<%--<form name="form" method="post" action="<venus:base/>/AuPartyRelationTypeAction.do">--%>
	...
	<form name="form" method="post" action="<venus:base/>/auPartyRelationType/simpleQuery">
