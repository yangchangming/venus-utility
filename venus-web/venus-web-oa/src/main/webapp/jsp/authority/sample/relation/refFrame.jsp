...
<script>
	function ok_onClick()  {
		...
		window.parent.toSel_ReturnValue(ids);
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	<tr> 
		<td align="left" height="40">
			...
			<input type="button" name="btn_close" class="button_ellipse" onClick="javascript:cancel_onClick();" value="<fmt:message key='venus.authority.Cancel' bundle='${applicationAuResources}' />">
		</td>
	</tr>
  	<tr> 
    	<td height="510">
    		<iframe name="myList" width="100%" height="100%" 
				...
				src="<%=request.getContextPath()%>/<%=actionStr%>/queryAll">
    		</iframe>
    	</td> 
  	</tr>
</table>
