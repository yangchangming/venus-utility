...
<%  //取出本条记录
	...
	if(resultVo==null){
		...
		resultVo.setCompany_name("该公司已被删除");
	}
...
%>
<%@page import="venus.frames.base.exception.BaseApplicationException"%>
<html>
<head>
...
<script language="javascript">
	...
	function find_onClick(){  //直接点到修改页面
		form.action="<%=request.getContextPath()%>/company/find";
		form.cmd.value = "find";
		form.submit();
	}
	function delete_onClick(){  //直接点删除单条记录
		...
		if(!confirm("<fmt:message key='venus.authority.This_operation_will_completely_remove_the_company' bundle='${applicationAuResources}' />\n"
		+ "<fmt:message key='venus.authority.Are_you_sure_you_do_this_' bundle='${applicationAuResources}' />")) {
			return false;
		}
		form.action="<%=request.getContextPath()%>/company/delete";
	...
	<tr>
		<td>
			...
			%>
				...
				<input name="button_change" class="button_ellipse" type="button" value="<fmt:message key='venus.authority.Tone_level' bundle='${applicationAuResources}' />" onClick="javascript:getChangeTree(new Array(),'<venus:base/>','radio','','1','','1','1');">
			<%
			}
			%>
		</td>
	...
	<tr>
		<td>
			<table class="table_div_content_inner">
				<tr>
					<td width="30%" align="right" nowrap="true"><fmt:message key='venus.authority.Company_Name_' bundle='${applicationAuResources}' /></td>
					<td width="70%" align="left" nowrap="true"><%=StringHelperTools.prt(resultVo.getCompany_name())%></td>
				</tr>
				<tr>
					<td align="right" nowrap="true"><fmt:message key='venus.authority.Code_' bundle='${applicationAuResources}' /></td>
					<td align="left" nowrap="true"><%=StringHelperTools.prt(resultVo.getCompany_no())%></td>
				</tr>
				<tr>
					<td align="right" nowrap="true"><fmt:message key='venus.authority.Company_Abbreviation_' bundle='${applicationAuResources}' /></td>
					<td align="left" nowrap="true"><%=StringHelperTools.prt(resultVo.getShort_name())%></td>
				</tr>
				<tr>
					<td align="right" nowrap="true"><fmt:message key='venus.authority.Company_ID_' bundle='${applicationAuResources}' /></td>
					<td align="left" nowrap="true"><%=StringHelperTools.prt(resultVo.getCompany_flag())%></td>
				</tr>
				<tr>
					<td align="right" nowrap="true"><fmt:message key='venus.authority.Type_0' bundle='${applicationAuResources}' /></td>
					<td align="left" nowrap="true"><%=StringHelperTools.prt(resultVo.getCompany_type())%></td>
				</tr>
				<tr>
					<td align="right" nowrap="true"><fmt:message key='venus.authority.Company_level_' bundle='${applicationAuResources}' /></td>
					<td align="left" nowrap="true"><%=StringHelperTools.prt(resultVo.getCompany_level())%></td>
				</tr>
				<tr>
					<td align="right" nowrap="true"><fmt:message key='venus.authority.Your_area_' bundle='${applicationAuResources}' /></td>
					<td align="left" nowrap="true"><%=StringHelperTools.prt(resultVo.getArea())%></td>
				</tr>
				<tr>
					<td align="right" nowrap="true"><fmt:message key='venus.authority.Contact_' bundle='${applicationAuResources}' /></td>
					<td align="left" nowrap="true"><%=StringHelperTools.prt(resultVo.getLinkman())%></td>
				</tr>
				<tr>
					<td align="right" nowrap="true"><fmt:message key='venus.authority.Tel_' bundle='${applicationAuResources}' /></td>
					<td align="left" nowrap="true"><%=StringHelperTools.prt(resultVo.getTel())%></td>
				</tr>
				<tr>
					<td align="right" nowrap="true"><fmt:message key='venus.authority.Fax_' bundle='${applicationAuResources}' /></td>
					<td align="left" nowrap="true"><%=StringHelperTools.prt(resultVo.getFax())%></td>
				</tr>
				<tr>
					<td align="right" nowrap="true"><fmt:message key='venus.authority.Postal_Code_' bundle='${applicationAuResources}' /></td>
					<td align="left" nowrap="true"><%=StringHelperTools.prt(resultVo.getPostalcode())%></td>
				</tr>
				<tr>
					<td align="right" nowrap="true"><fmt:message key='venus.authority.Address_0' bundle='${applicationAuResources}' /></td>
					<td align="left" nowrap="true"><%=StringHelperTools.prt(resultVo.getAddress())%></td>
				</tr>
				<tr>
					<td align="right" nowrap="true"><fmt:message key='venus.authority.E_mail_' bundle='${applicationAuResources}' /></td>
					<td align="left" nowrap="true"><%=StringHelperTools.prt(resultVo.getEmail())%></td>
				</tr>
				<tr>
					<td align="right" nowrap="true"><fmt:message key='venus.authority.Website_' bundle='${applicationAuResources}' /></td>
					<td align="left" nowrap="true"><%=StringHelperTools.prt(resultVo.getWeb())%></td>
				</tr>
				<!--tr>
