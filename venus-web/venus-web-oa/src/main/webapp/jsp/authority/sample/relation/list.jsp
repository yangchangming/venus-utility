...
<%
    ...
    IAuPartyRelationTypeBS bs = (IAuPartyRelationTypeBS)venus.frames.mainframe.util.Helper.getBean(IConstants.BS_KEY);
    String relationTypeName = ((AuPartyRelationTypeVo)bs.find(parentCode.substring(0,19))).getName();
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td>&nbsp;&nbsp;</td>
      ...
      <table width="100%" height="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#7EBAFF">
        <tr>
          <td bgcolor="#FFFFFF"> 
    ...
    <td valign="top">
      <table width="95%"  height="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#7EBAFF" >
        <tr> 
