...
<title><fmt:message key='venus.authority.Organization_Sort' bundle='${applicationAuResources}' /></title>
...
function sort_onClick() {
	...
	for (var i=box.options.length-1; i>=0; i--) {
   	...
   	document.form1.action= "<%=request.getContextPath()%>/relation/sort";
...
<table class="table_div_control">
	<tr> 
		<td>
			<img src="<venus:base/>/themes/<venus:theme/>/images/icon/07-0.gif" class="div_control_image" onClick="javascript:hideshow('ccChild1',this,'<%=request.getContextPath()%>/themes/<venus:theme/>/')"><fmt:message key='venus.authority.Organization_Sort' bundle='${applicationAuResources}' />
		</td>
	</tr>
</table>
</div>
				...
				<table class="table_div_content_inner">
					...
					<tr>
						...
						<td align="left" colspan="2">
							<input type="text" class="text_field_readonly" name="parent_name" inputname="<fmt:message key='venus.authority.Parent_node' bundle='${applicationAuResources}' />" value="<%=parentVo.getName()%>" maxlength="30" />
							<input type="hidden" name="parent_code" value="<%=parentVo.getCode()%>"/>
						</td>
					</tr>
					<tr> 
						<td align="right"><fmt:message key='venus.authority.Sort_list' bundle='${applicationAuResources}' /></td>
						<td align="left">			
