	...
	<tr>
	   <td >    
	       <div id="Layer012" style="position:absolute; width:24px; height:115px; z-index:0; layer-background-color: #f5f5f5; border: 0px none #ffffff;top:200px" >    
	           <img src="<%=request.getContextPath() %>/themes/<venus:theme/>/images/au/close.gif" title = "<fmt:message key='venus.authority.hidemenu' bundle='${applicationAuResources}' />" width="10" height="50" showImage1="<%=request.getContextPath() %>/themes/<venus:theme/>/images/au/close.gif" showImage2="<%=request.getContextPath() %>/themes/<venus:theme/>/images/au/close_01.gif" hiddImage1="<%=request.getContextPath() %>/themes/<venus:theme/>/images/au/open.gif" hiddImage2="<%=request.getContextPath() %>/themes/<venus:theme/>/images/au/open_01.gif" onMouseOver="doMouseOverImg(event)" onMouseOut="doMouseOutImg(event)" status1="show" style="cursor:hand;cursor:pointer;" onClick="hiddenFuncTree(event)" name="Image26" width="24" height="43" border="0">
	       </div>
	    </td>
	</tr>
</table>
