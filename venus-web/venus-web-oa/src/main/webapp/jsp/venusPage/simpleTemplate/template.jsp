...
<script>
	...
	function toAdd_onClick() {  //到增加记录页面
		window.location="<venus:base/>/jsp/venusPage/simpleTemplate/insertRoom.jsp";
	}
...
<form id="form" name="form" method="post" action="<venus:base/>/TemplateAction.do">
			...
			<td> 
				<table align="right">
					<tr>
						...
						<td class="button_ellipse" onClick="javascript:exportPdf_onClick();"><img src="<venus:base/>/themes/<venus:theme/>/images/icon/pdf.gif" class="div_control_image"><fmt:message key="ExportPdf"/></td>
						<td class="button_ellipse" onClick="javascript:exportExcel_onClick();"><img src="<venus:base/>/themes/<venus:theme/>/images/icon/xls.gif" class="div_control_image"><fmt:message key="ExportExcel"/></td>
						<td class="button_ellipse" onClick="javascript:printTable();"><img src="<venus:base/>/themes/<venus:theme/>/images/icon/print.gif" class="div_control_image"><fmt:message key="print_table"/></td>
				    </tr>
				</table>
			</td>
		</tr>
