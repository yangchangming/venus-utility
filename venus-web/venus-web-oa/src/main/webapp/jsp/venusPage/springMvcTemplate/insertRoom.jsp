...
<script>
    ...
    function isRoomExist(value, obj) {
        ...
        jQuery.ajax({
            ...
            cache: false, //禁用缓存
            async:false, //同步方式
            data:{ build_Id:jQuery("input[name='build_Id']").val(),name:value, id:''}, // 要传递的数据
...
<table class="table_div_content">
	...
	<tr>
		...
		<td align="left">
			<input name="price" type="text" class="text_field" inputName='<fmt:message key="RoomRate"/>' validate="isInteger" value="0">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td align="left">
			<input name="residing_Date" id="residing_Date" type="text" class="text_field_reference" inputName='<fmt:message key="CheckinDate"/>' validate="notNull" readonly="true" value="">
