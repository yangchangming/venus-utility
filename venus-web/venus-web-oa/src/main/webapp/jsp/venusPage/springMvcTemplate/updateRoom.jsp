...
<script>
	...
	function insert_onClick(){
		if(checkAllForms()){
    		form.action = "<venus:base/>/template/add";
    		form.submit();
    	}
  	}
  	function update_onClick(){
	  	if(checkAllForms()){
  			form.action = "<venus:base/>/template/update";
  			form.submit();
  		}
  	}
    ...
    function isRoomExist(value, obj) {
        ...
        jQuery.ajax({
            type: "get", // 数据发送方式
            url: '<venus:base/>/template/validate/isRoomExist', // 后台处理程序
...
<table class="table_div_content">
	<tr> 
		...
		<td align="left">
			<input name="build_Id" type="hidden" value="<bean:write name='bean' property='build_Id'/>">
	...
	<tr>
		...
		<td align="left">
            ...
            <input name="name" type="text" class="text_field" maxlength="25" inputName='<fmt:message key="RoomName"/>' validate="notNull;isRoomExist" value="<bean:write name='bean' property='name'/>">
	...
	<tr>
		...
		<td align="left">
            <input name="area" type="text" class="text_field" maxValue="9999999" inputName='<fmt:message key="BuildingArea"/>' validate="notNull;isNumeric;numberMax" value="<bean:write name='bean' property='area'/>">
		</td>
	</tr>
		<tr>
	...
	<tr>
		...
		<td align="left">
			<input name="price" type="text" class="text_field" inputName='<fmt:message key="RoomRate"/>' validate="isInteger" value="<bean:write name='bean' property='price'/>">
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td align="left">
			<input name="residing_Date" id="residing_Date" type="text" class="text_field_reference" inputName='<fmt:message key="CheckinDate"/>' validate="notNull" readonly="true" value="<bean:write name='bean' property='residing_Date'/>">
            <img src="<venus:base/>/themes/<venus:theme/>/images/icon/reference.gif" onclick="javacript:getYearMonthDay('residing_Date','<venus:base/>/');" class="img_1">
	...
	<tr>
		...
		<td align="left">
				<input name="brief" type="text" class="text_field" value="<bean:write name='bean' property='brief'/>">
		</td>
	</tr>
</table>
</div>
