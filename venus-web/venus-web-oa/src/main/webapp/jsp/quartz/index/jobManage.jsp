...
<div class="main">
<br />
  <div id="tc" align="left"><img src="<%=request.getContextPath()%>/themes/<venus:theme/>/images/index/icon.png" />&nbsp;作业管理</div>
  <div class="side">
    <div id="firstpane" class="menu_list">
        <div class="menu_body">
         <a href="<%=request.getContextPath()%>/queryJobDefines.do"  target="bodyFrame">查看作业</a>  
        </div>
        
        <div class="menu_body">
         <a href="<%=request.getContextPath()%>/createJobForm.do?cmd=doCreateJobForm"  target="bodyFrame">创建作业</a>  
        </div>
    </div>
  </div>
