 ...
 */
public class SimpleStatisticListenerImpl implements
		CacheMapAccessEventListener, CacheEntryEventListener,
		ScopeEventListener {

	private static transient final Log log = LogFactory
			.getLog(SimpleStatisticListenerImpl.class);
	 ...
	 * @see CacheMapAccessEventListener#accessed(CacheMapAccessEvent)
	 */
	 ...
	 * @param event
	 *            ScopeEvent
	 * @see ScopeEventListener#scopeFlushed(ScopeEvent)
	 */
	 ...
	 * @param event
	 *            CacheEntryEvent
	 * @see CacheEntryEventListener#cacheEntryAdded(CacheEntryEvent)
	 */
	 ...
	 * @param event
	 *            CacheEntryEvent
	 * @see CacheEntryEventListener#cacheEntryFlushed(CacheEntryEvent)
	 */
	 ...
	 * @param event
	 *            CacheEntryEvent
	 * @see CacheEntryEventListener#cacheEntryRemoved(CacheEntryEvent)
	 */
	 ...
	 * @param event
	 *            CacheEntryEvent
	 * @see CacheEntryEventListener#cacheEntryUpdated(CacheEntryEvent)
	 */
	 ...
	 * @param event
	 *            CacheGroupEvent
	 * @see CacheEntryEventListener#cacheGroupFlushed(CacheGroupEvent)
	 */
	 ...
	 * @param event
	 *            CachePatternEvent
	 * @see CacheEntryEventListener#cachePatternFlushed(CachePatternEvent)
	 */
	 ...
	 * @param event
	 *            CachewideEvent
	 * @see CacheEntryEventListener#cacheFlushed(CachewideEvent)
	 */
	...
	public String toString() {
		return "SimpleStatisticListenerImpl: Hit = " + hitCount + " / "
				+ hitCountSum + ", stale hit = " + staleHitCount + " / "
				+ staleHitCountSum + ", miss = " + missCount + " / "
				+ missCountSum + ", flush = " + flushCount;
	}
}