 ...
 * @author 岳国云
 */
public class DefaultLogImpl implements ILogger, Serializable {
	...
	public boolean isDebugEnabled() {
		return DefaultLogSwitch.LOG_DEBUG;
	}
	...
	public void debug(Object message) {
		...
		if ( DefaultLogSwitch.LOG_WARN && DefaultLogSwitch.LOG_DEBUG ) System.out.println(System.currentTimeMillis()+":["+m_strCaller+"][debug] "+message);
	...
	public void info(Object message) {
		if ( DefaultLogSwitch.LOG_WARN && DefaultLogSwitch.LOG_DEBUG ) System.out.println(System.currentTimeMillis()+":["+m_strCaller+"][info] "+message);
	}
	...
	public void warn(Object message) {
		if ( DefaultLogSwitch.LOG_WARN ) System.out.println(System.currentTimeMillis()+":["+m_strCaller+"][warn] "+message);
	}
	...
	public void error(Object message) {
		...
		if ( DefaultLogSwitch.LOG_WARN ) System.out.println(System.currentTimeMillis()+":["+m_strCaller+"][error] "+message);
	}
	...
	public void fatal(Object message) {
		if ( DefaultLogSwitch.LOG_WARN ) System.out.println(System.currentTimeMillis()+":["+m_strCaller+"][fatal] "+message);
	}
	...
	public void debug(Object message, Throwable t) {
		if ( DefaultLogSwitch.LOG_WARN && DefaultLogSwitch.LOG_DEBUG ) {
			System.out.println(System.currentTimeMillis()+":["+m_strCaller+"][debug] "+message);
			t.printStackTrace();
		}
	}
	...
	public void info(Object message, Throwable t) {
		if ( DefaultLogSwitch.LOG_WARN && DefaultLogSwitch.LOG_DEBUG ) {
			System.out.println(System.currentTimeMillis()+":["+m_strCaller+"][info] "+message);
			t.printStackTrace();
		}
	}
	...
	public void warn(Object message, Throwable t) {
		if ( DefaultLogSwitch.LOG_WARN ) {
			System.out.println(System.currentTimeMillis()+":["+m_strCaller+"][warn] "+message);
			t.printStackTrace();
		}
	}
	...
	public void error(Object message, Throwable t) {
		if ( DefaultLogSwitch.LOG_WARN ) {
			System.out.println(System.currentTimeMillis()+":["+m_strCaller+"][error] "+message);
			t.printStackTrace();
		}
	}
	...
	public void fatal(Object message, Throwable t) {
		if ( DefaultLogSwitch.LOG_WARN ) {
			...
			System.out.println(System.currentTimeMillis()+":["+m_strCaller+"][fatal] "+message);
			t.printStackTrace();
		}
	}
