...
public interface IHotWordsConstants {

    //BS的规划化名称
    public final static String BS_KEY = "IHotWordsBs";
    ...
    public final static String FORWARD_TABLE_PAGE = "tablePage";
    ...
    public final static String REQUEST_MAP = "map";
    ...
    //表名
    public final static String TABLE_NAME = "ewp_hot_words";
}
