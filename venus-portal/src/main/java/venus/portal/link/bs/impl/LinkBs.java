...
package venus.portal.link.bs.impl;

import venus.frames.base.bs.BaseBusinessService;
import venus.portal.link.bs.ILinkBs;
import venus.portal.link.dao.ILinkDao;
...
public class LinkBs extends BaseBusinessService implements ILinkBs, ILinkConstants {
    
    /**
     * dao 表示: 数据访问层的实例
     */
    private ILinkDao dao = null;
