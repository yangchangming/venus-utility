package venus.portal.gbox.resource.customizelib.dao.impl;

import org.springframework.jdbc.core.RowMapper;
import venus.frames.base.dao.BaseTemplateDao;
import venus.frames.mainframe.util.Helper;
import venus.frames.mainframe.util.VoHelper;
import venus.portal.gbox.resource.customizelib.dao.ICustomizeLibDao;
...
public class CustomizeLibDao extends BaseTemplateDao implements ICustomizeLibDao, ICustomizeLibConstants {
     ...
     */
    public OID insert(CustomizeVo vo) {
     ...
     */
    public int delete() {
        String strsql = SQL_DELETE_MULTI_BY_IDS;
    ...
    public int delete(String id) {
        if (id == null || "".equals(id))
            return 0;
        String strsql = SQL_DELETE_MULTI_BY_IDS + " WHERE ID = '" + id + "'";
        return update(strsql);
    }    
     ...
     * @return 查询到的VO对象
     */
    public CustomizeVo find(String id) {
        return (CustomizeVo) queryForObject(SQL_FIND_BY_ID, new Object[] { id }, new RowMapper() {
     ...
     * @return 成功更新的记录数
     */
    public int update(CustomizeVo vo) {
        VoHelper.null2Nothing(vo); //把vo中null值替换为""
        Object[] obj = { vo.getName(),vo.getCode(),vo.getTag(),vo.getModifierName(),vo.getModifyDate(),vo.getEnableStatus(),vo.getDescription(), vo.getId() };
     ...
     * @return 查询到的VO列表
     */
    public List<CustomizeVo> queryByCondition(String queryCondition) {
     ...
     * @return 查询到的VO列表
     */
    public List<CustomizeVo> queryByCondition(int no, int size, String queryCondition, String orderStr) {
