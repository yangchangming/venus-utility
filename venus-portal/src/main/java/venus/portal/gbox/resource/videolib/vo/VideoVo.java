package venus.portal.gbox.resource.videolib.vo;
...
public class VideoVo extends BaseValueObject {
    ...
    /**
     * @param thumbsName the thumbsName to set
     */
    ...
    /**
     * @return the thumbsObject
     */
    public File getThumbsObject() {
        return thumbsObject;
    }

    /**
     * @param thumbsObject the thumbsObject to set
     */
    public void setThumbsObject(File thumbsObject) {
