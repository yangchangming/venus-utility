package venus.portal.gbox.resource.imagelib.dao.impl;

import org.springframework.jdbc.core.RowMapper;
//import venus.authority.util.VoHelperTools;
...
public class ImageLibDao extends BaseTemplateDao implements IImageLibDao, IImageLibConstants {
...
//        VoHelperTools.null2Nothing(vo); //把vo中null值替换为""
    ...
    public ImageVo find(String id) {
        return (ImageVo) queryForObject(SQL_FIND_BY_ID, new Object[] { id }, new RowMapper() {
...
//        VoHelperTools.null2Nothing(vo); //把vo中null值替换为""
     ...
     * @return 查询到的VO列表
     */
    public List<ImageVo> queryByCondition(String queryCondition) {
