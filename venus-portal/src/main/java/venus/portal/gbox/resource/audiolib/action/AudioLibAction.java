package venus.portal.gbox.resource.audiolib.action;
...
public class AudioLibAction extends DefaultDispatchAction implements IAudioLibConstants {
    /**
     * 得到BS对象
     * 
     * @return BS对象
     */
    public IAudioLibBs getBs() {
        return (IAudioLibBs) Helper.getBean(BS_KEY);  //得到BS对象,受事务控制
    }
    ...
    public IForward deleteMulti(DefaultForm formBean, IRequest request, IResponse response) throws Exception {
        ...
        String uploadPath = ResourceTypeAPI.getResourceTypeUploadPath(ResourceTypeAPI.getAudioType());
    ...
    public IForward detail(DefaultForm formBean, IRequest request, IResponse response) throws Exception {
        AudioVo vo = getBs().find(request.getParameter(REQUEST_ID));  //通过id获取vo
    ...
    public IForward upload(DefaultForm formBean, IRequest request, IResponse response) throws Exception {
        ...
        AudioVo vo = new AudioVo();
        String audioUploadPath = ResourceTypeAPI.getResourceTypeUploadPath(ResourceTypeAPI.getAudioType());
        String audioRealPath = audioUploadPath + FileTools.FILE_SEPARATOR + FileUpload.getDatePath();
        String uploadPath = FileUpload.getUploadPath(audioRealPath,isProtectedFile);
