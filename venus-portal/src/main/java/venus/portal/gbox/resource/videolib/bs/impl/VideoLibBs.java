package venus.portal.gbox.resource.videolib.bs.impl;
...
import venus.portal.gbox.resource.videolib.dao.IVideoLibDao;
...
public class VideoLibBs extends BaseBusinessService implements IVideoLibBs, IVideoLibConstants {

    
    /**
     * dao 表示: 数据访问层的实例
     */
    private IVideoLibDao dao = null;
     ...
     * @param dao
     */
    public void setDao(IVideoLibDao dao) {
        this.dao = dao;
    }
    ...
    public OID insert(VideoVo vo) {
        ...
        resVo.setType(ResourceTypeAPI.getVideoType());
     ...
     */
    public int delete() {
        List<VideoVo> list = getDao().queryByCondition("");
    ...
    public List<VideoVo> queryByCondition(int no, int size, String queryCondition, String orderStr) {
        List<VideoVo> lResult = getDao().queryByCondition(no, size, queryCondition, orderStr);
        return lResult;
    }
}
