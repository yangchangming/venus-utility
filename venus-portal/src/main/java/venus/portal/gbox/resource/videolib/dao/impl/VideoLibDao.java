package venus.portal.gbox.resource.videolib.dao.impl;
...
public class VideoLibDao extends BaseTemplateDao implements IVideoLibDao, IVideoLibConstants {
    ...
    public VideoVo find(String id) {
        return (VideoVo) queryForObject(SQL_FIND_BY_ID, new Object[] { id }, new RowMapper() {
